            ...
            <div className="row book1-row1">
                <div className="col-sm-12 col-md-12 col-lg-6 book1-col">
                    <div className="book1-image">
                        <img src="images/Hotelroomport/hotelroom7port.jpg" alt="" className="book1-img"/>
                    </div>
                </div>
                ...
                <div className="col-sm-12 col-md-12 col-lg-6 book1-col">
                    <div className="row">
                        <div className="col-sm-12 col-md-6 col-lg-6 book1-sub-col">
                            <div className="column1-image">
                                <img src="images/Hotelroomland/hotelroom13land.jpg" alt="" className="col-img" />
                            </div>
                        </div>
                        
                        <div className="col-sm-12 col-md-6 col-lg-6 ">
                            <div className="column1-image">
                                <img src="images/Hotelroomland/hotelroom14land.jpg" alt="" className="col-img" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row row-control">
                        ...
                        <div className="col-sm-12 col-md-6 col-lg-6">
                            <div className="column1-image">
                                <img src="images/Hotelroomland/hotelroom5land.jpg" alt="" className="col-img" />
                            </div>
                        </div>
                    </div>
                </div>
